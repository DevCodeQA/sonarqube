...
public class InitFilter extends AuthenticationFilter {
  ...
  private final AuthenticationParameters oAuthAuthenticationParameters;

  public InitFilter(IdentityProviderRepository identityProviderRepository, BaseContextFactory baseContextFactory,
    OAuth2ContextFactory oAuth2ContextFactory, Server server, AuthenticationEvent authenticationEvent, AuthenticationParameters oAuthAuthenticationParameters) {
